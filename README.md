...
I design and build production-oriented backend systems focused on scalability, automation, and AI-native architectures.
...
I enjoy solving complex backend problems involving asynchronous processing, orchestration, state management, and real-world operational constraints.

Currently focused on:
- AI-native backend platforms
- Multi-agent systems
